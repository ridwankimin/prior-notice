              ...
              <div className="flex md:order-2 mt-4">
                  <Navbar.Collapse className='mr-20'>
                      ...
                      <Dropdown inline label="Create Document">
                          <Dropdown.Item><Link to="/create/kh">Animal & Animal Product</Link></Dropdown.Item>
                          <Dropdown.Item><Link to="/create/ki">Aquatic Animal & Product</Link></Dropdown.Item>
                          <Dropdown.Item><Link to="/create/kt">Plant & Plant Product</Link></Dropdown.Item>
